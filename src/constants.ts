/**
 * SELFIES constants - elements, valences, and alphabet definitions
...
export const AROMATIC_VALENCES: { [key: string]: number[] } = {
    "B": [3], "Al": [3],
    "C": [4], "Si": [4],
    "N": [3, 5], "P": [3, 5], "As": [3, 5],
...
export const VALENCE_ELECTRONS: { [key: string]: number } = {
    "B": 3, "Al": 3,
    "C": 4, "Si": 4,
    "N": 5, "P": 5, "As": 5,
    "O": 6, "S": 6, "Se": 6, "Te": 6
...
export const INDEX_CODE: { [key: string]: number } = {};
